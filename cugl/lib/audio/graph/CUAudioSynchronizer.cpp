...
//
//  This is a highly experimental beat detector for use in rhythm games.
//  It has not been fully tested, and has known problems when the buffer
//  is to large (increasing latency).  Use at your own risk.
//
//  CUGL MIT License:
//
...
bool AudioSynchronizer::onBeat() {
    ...
    Uint32 size = AudioDevices::get()->getReadSize();
