...
//  the factory PolySplineFactory.  We have to turn shapes into polygons
 ...
 * {@link PolySplineFactory} factory.  This factory creates a line-segment
...
public:
     ...
     */
    Spline2(const Vec2 point) : Spline2(point,point)  {    }
     ...
     */
    Spline2(Spline2&& spline) : _size(spline._size), _closed(spline._closed),
...
#pragma mark Assignment Operators
     ...
     */
    Spline2& operator=(const Spline2& spline) { return set(spline); }
     ...
     * @return This spline, returned for chaining
     */
    Spline2& operator=(Spline2&& spline) {
     ...
     * @return This spline, returned for chaining
     */
    Spline2& set(const Vec2 point) { return set(point,point); }
     ...
     * @return This spline, returned for chaining
     */
    Spline2& set(const Vec2 start, const Vec2 end);
     ...
     * @return This spline, returned for chaining
     */
    Spline2& set(const float* points, int size);
     ...
     * @return This spline, returned for chaining
     */
    Spline2& set(const std::vector<float>& points);
     ...
     * @return This spline, returned for chaining
     */
    Spline2& set(const std::vector<Vec2>& points);
     ...
     * @return This spline, returned for chaining
     */
    Spline2& set(const Spline2& spline);
...
protected:
    ...
    void subdivide(int segment, float tp, std::vector<Vec2>& left, std::vector<Vec2>& rght) const {
        subdivide(_points,3*segment,tp,left,rght);
    }
