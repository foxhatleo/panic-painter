...
#pragma mark Operators
     ...
     */
    Rect& operator*=(const Affine2& transform) { return circumscribe(transform); }
     ...
     * @return This rectangle, as the bounding box of the transformed quadrilateral.
     */
    Rect& operator*=(const Mat4& transform)  { return circumscribe(transform); }
     ...
     * necessarily produce a rectangle (particularly when the transform includes
     * a rotation). Instead, it produces a quadrilateral polygon. The method
     * returns the unique circumscribing rectangle that shares the same center 
     ...
     */
    Rect operator*(const Affine2& transform) const { return getCircumscription(transform); }
     ...
     * @return the bounding box of the transformed quadrilateral.
     */
    Rect operator*(const Mat4& transform) const { return getCircumscription(transform); }
