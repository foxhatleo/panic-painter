//
//  CUPolySplineFactory.h
//  Cornell University Game Library (CUGL)
//
//  This module is a factory for producing Poly2 objects from Spline2.
...
#pragma mark Constructors
     ...
     */
    PolySplineFactory() : _spline(nullptr), _calculated(false) { }
     ...
     */
    PolySplineFactory(const Spline2* spline) : _spline(spline), _calculated(false) { }
