 ...
 * to be converted to a 3x3 matrix (for {@link Shader} or a 3x4 matrix
 * (for a {@link UniformBuffer}). For that reason this class contains
 * several static methods for processing float arrays of different strides.
 * These methods interpret stride pairwise.  For example, a stride of 4
 * corresponds to a 3x4 matrix with the first two elements at position 0
