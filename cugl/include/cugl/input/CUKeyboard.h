 ...
 *
 * This namespace is for all classes and functions internal to the CUGL game engine.
 * It does not include external tools like Box 2d or poly2tri.
 */
namespace cugl {
...
#pragma mark Constructor
     ...
     */
    bool init() { return initWithName("Keyboard"); }
