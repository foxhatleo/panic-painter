 ...
 * the screen. This is typically done via the {@link scene2::Label} class, though 
 * the methods are available for any rendering pipeline.
 *
...
#pragma mark Rendering
     ...
     */
    std::shared_ptr<Texture> getMesh(const std::string text, const Vec2 origin,
                                     Mesh<SpriteVertex2>& mesh, bool utf8=true);
     ...
     * @return the texture associated with the mesh
     */
    std::shared_ptr<Texture> getMesh(const std::string text, const Vec2 origin, const Rect rect,
                                      Mesh<SpriteVertex2>& mesh,  bool utf8=true);
     ...
     * @return the texture associated with the mesh
     */
    std::shared_ptr<Texture> getQuad(Uint32 thechar, Vec2& offset, Mesh<SpriteVertex2>& mesh);
     ...
     */
    std::shared_ptr<Texture> getMesh(const std::string text, const Vec2 origin,
                                     Mesh<SpriteVertex3>& mesh, float z = 0, bool utf8=true);
     ...
     * @return the texture associated with the mesh
     */
    std::shared_ptr<Texture> getQuad(Uint32 thechar, Vec2& offset, Mesh<SpriteVertex3>& mesh, float z=0);
     ...
     */
    std::shared_ptr<Texture> getQuad(Uint32 thechar, Vec2& offset, const Rect rect,
                                     Mesh<SpriteVertex3>& mesh, float z=0);
...
protected:
     ...
     * @param utf8      Whether the string is a UTF8 that must be decoded.
     */
    void getAtlasMesh(const std::string text, const Vec2 origin, const Rect rect,
     ...
     */
    std::shared_ptr<Texture> getRenderedMesh(const std::string text, const Vec2 origin,
     ...
     */
    std::shared_ptr<Texture> getRenderedMesh(const std::string text, const Vec2 origin,
                                             const Rect rect, Mesh<SpriteVertex3>& mesh,
                                             float z, bool utf8);
     ...
     * @return true if the right edge of the glyph was generated
     */
    bool getAtlasQuad(Uint32 thechar, Vec2& offset, const Rect rect,
